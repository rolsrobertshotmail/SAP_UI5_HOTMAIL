		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#namespaceproject1ui5hotmail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespaceproject1ui5hotmail-display": {
								"semanticObject": "namespaceproject1ui5hotmail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespace.project1ui5hotmail",
									"url": sap.ui.require.toUrl("namespace/project1ui5hotmail")
								}
							}
						}
					}
